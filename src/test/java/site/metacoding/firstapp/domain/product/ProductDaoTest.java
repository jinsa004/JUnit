...
public class ProductDaoTest {
    ...
    public void findAll_test() {
        // given
        // findAll()은 받는 매개변수가 없기때문에 given을 안해줌
        // when
    ...
    // MyBatis는 ResultSet을 자바 Entity로 변경해줄 때
    // 하지만 mybatis는 빈생성자를 호출하고 setter가 없어도 값을 매핑해준다.
    // 요건 기본적으로 이런 구조를 가지는 것(1.빈생성자 + setter, 2.풀생성자를 호출하고 끝.)
    @Test
    ...
    public void update_test() {
        ...
        // verify
        Product productPS = productDao.findById(product.getProductId()); // 영속화
    ...
    public void deleteById() {
        ...
        // verify
        Product productPS = productDao.findById(productId); // 영속화
        assertTrue(productPS == null ? false : true);
        // when
